...
const Footer: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Footer Content */}
      <footer className="bg-white py-4 dark:bg-black border-t border-gray-800">
        <div className="max-w-screen-xl mx-auto p-4 md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400 font-bold">
            © {new Date().getFullYear()} Mohamed Amine Abdelouafi (Am1neABDSec). All Rights Reserved.
          </span>
          <ul className="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
            <li>
              <span className="mr-4">Offensive Security Portfolio</span>
            </li>
            <li>
